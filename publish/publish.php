...
foreach ($phpVersions as $phpVersion) {
    ...
    echo "- build image\n";
    passthru(implode(' ', [
      "docker build " . __DIR__ . "/civicrm/php{$phpVersion}",
      "--no-cache -t michaelmcandrew/civicrm-buildkit:php{$phpVersion}"
    ]));
    echo "- push image\n";
...
echo "push 'latest'";
passthru(implode(" ", [
  "docker tag michaelmcandrew/civicrm-buildkit:php$defaultVersion",
  "michaelmcandrew/civicrm-buildkit:latest"
]));
